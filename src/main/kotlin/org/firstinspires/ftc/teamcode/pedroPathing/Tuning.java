...
public class Tuning extends SelectableOpMode {
    ...
    /** This creates a full stop of the robot by setting the mecanum motors to run at 0 power. */
...
/**
 * This is the LocalizationTest OpMode. This is basically just a simple mecanum mecanum attached to a
...
class LocalizationTest extends OpMode {
    ...
    /** This initializes the PoseUpdater, the mecanum mecanum motors, and the Panels telemetry. */
    @Override
    public void init_loop() {
        Tuning.telemetryM.debug("This will print your robot's position to telemetry while "
                + "allowing robot control through a basic mecanum mecanum on gamepad 1.");
    ...
    /**
     * This updates the robot's pose estimate, the simple mecanum mecanum, and updates the
...
class ForwardVelocityTuner extends OpMode {
    ...
    /** This initializes the mecanum motors as well as the cache of velocities and the Panels telemetry. */
    @Override
    public void init_loop() {
    ...
    /** This starts the OpMode by setting the mecanum motors to run forward at full power. */
    @Override
    public void start() {
...
class LateralVelocityTuner extends OpMode {
    ...
    /**
     * This initializes the mecanum motors as well as the cache of velocities and the Panels
     * telemetryM.
     */
    @Override
    public void init_loop() {
    ...
    /** This starts the OpMode by setting the mecanum motors to run left at full power. */
    @Override
    public void start() {
        for (int i = 0; i < RECORD_NUMBER; i++) {
            velocities.add(0.0);
 ...
 * mecanum Vector more accurate and giving better braking at the end of Paths.
 *
 * @author Anyi Lin - 10158 Scott's Bots
 * @author Baron Henderson - 20077 The Indubitables
 * @author Aaron Yang - 10158 Scott's Bots
...
class ForwardZeroPowerAccelerationTuner extends OpMode {
    ...
    /** This initializes the mecanum motors as well as the Panels telemetryM. */
    @Override
    public void init_loop() {
...
class LateralZeroPowerAccelerationTuner extends OpMode {
    ...
    /** This initializes the mecanum motors as well as the Panels telemetry. */
    @Override
    public void init_loop() {
...
/**
 * This is the Line Test Tuner OpMode. It will mecanum the robot forward and back
 * The user should push the robot laterally and angular to test out the mecanum, heading, and translational PIDFs.
 *
 * @author Baron Henderson - 20077 The Indubitables
 * @author Anyi Lin - 10158 Scott's Bots
 * @author Aaron Yang - 10158 Scott's Bots
...
class Line extends OpMode {
    ...
    public void init_loop() {
        ...
        Tuning.telemetryM.debug("You can adjust the PIDF values to tune the robot's mecanum PIDF(s).");
        Tuning.telemetryM.update(telemetry);
        Tuning.follower.update();
        Tuning.drawOnlyCurrent();
    }
 ...
 * of Vectors, like the mecanum Vector, the translational Vector, the heading Vector, and the
 * centripetal Vector.
 *
 * @author Baron Henderson - 20077 The Indubitables
 * @author Anyi Lin - 10158 Scott's Bots
